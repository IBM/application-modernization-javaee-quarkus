...
public class SerializationUtil {
    ...
    static {
        ...
        type_category_map.put("org.pwte.example.domain.AbstractCustomer", "USER_LOCAL_TYPE");
        type_category_map.put("org.pwte.example.domain.Address", "USER_REMOTE_TYPE");
        type_category_map.put("org.pwte.example.domain.BusinessCustomer", "USER_LOCAL_TYPE");
        type_category_map.put("org.pwte.example.domain.Category", "USER_REMOTE_TYPE");
        type_category_map.put("org.pwte.example.domain.LineItem", "USER_LOCAL_TYPE");
        type_category_map.put("org.pwte.example.domain.LineItemId", "USER_REMOTE_TYPE");
        type_category_map.put("org.pwte.example.domain.Order", "USER_LOCAL_TYPE");
        type_category_map.put("org.pwte.example.domain.Product", "USER_REMOTE_TYPE");
        type_category_map.put("org.pwte.example.domain.ResidentialCustomer", "USER_LOCAL_TYPE");
        ...
        type_category_map.put("org.pwte.example.service.CustomerOrderServicesImpl", "USER_LOCAL_TYPE");
        type_category_map.put("org.pwte.example.service.ProductSearchServiceImpl", "USER_REMOTE_TYPE");
        ...
        type_category_map.put("org.pwte.example.resources.CategoryResource", "USER_REMOTE_TYPE");
        type_category_map.put("org.pwte.example.resources.CustomerOrderResource", "USER_LOCAL_TYPE");
        type_category_map.put("org.pwte.example.resources.ProductResource", "USER_REMOTE_TYPE");
    }
