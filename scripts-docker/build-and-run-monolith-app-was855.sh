...
function setup() {
  ...
  cd ${root_folder}/monolith-websphere-90/
  docker build -f Dockerfile855 --tag storefront-was855 .

  docker run -p 9043:9043 -p 9443:9443 --name storefront-was855 storefront-was855
}
